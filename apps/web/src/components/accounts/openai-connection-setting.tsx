...
export default function OpenAIConnectionSetting() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setApiKey('')
      setHasApiKey(clearApiKey ? false : (nextApiKey !== '' || hasApiKey))
      setEffectiveBaseUrl(baseUrl.trim() === '' ? effectiveBaseUrl : baseUrl.trim())
      setEffectiveModel(model.trim() === '' ? effectiveModel : model.trim())
      setHasEffectiveApiKey(clearApiKey ? false : (nextApiKey !== '' || hasEffectiveApiKey))
